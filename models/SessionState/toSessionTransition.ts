...
// // eslint-disable-next-line @typescript-eslint/ban-types
// export const toSessionTransition = <Err, Sess extends GenericSession<Err>>(isError: (e: unknown) => e is Err) => (getDataUpdate: SimpleGenericUpdate<Data, Out, Err>) => async (state: GenericState<Data, Out, Err>): Promise<GenericState<Data, Out, Err>> => {
//   try {
